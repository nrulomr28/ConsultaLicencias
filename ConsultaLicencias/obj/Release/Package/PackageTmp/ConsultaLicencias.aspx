...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:UpdateProgress ID="updPanProg_Actualización" runat="server" AssociatedUpdatePanelID="upFilter">
        <ProgressTemplate>
    ...
    <div class="row" style="text-align: center; background-color: yellow;">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            Atención: La consulta podría tardar, favor de especificar lo más posible dentro de los filtros.</div>
    </div>
        ...
        <ContentTemplate>
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                    <div class="input-group">
                        <span class="input-group-addon" style="min-width: 150px; text-align: left;">
                            <i class="glyphicon glyphicon-globe"></i>Colonia
                        </span>
                        <asp:TextBox ID="txtColonia" runat="server" Width="100%" autocomplete="off"></asp:TextBox>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                    <div class="input-group">
                        ...
                        <asp:TextBox ID="txtMunicipio" runat="server" Width="100%" autocomplete="off"></asp:TextBox>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                    <%-- <div class="col-lg-4 col-md-1 col-sm-1 col-xs-1"></div>
                    <div class="col-lg-8 col-md-1 col-sm-1 col-xs-1"></div>--%>
    ...
    <%-- <asp:UpdateProgress ID="upDetalle" runat="server" AssociatedUpdatePanelID="upListaLicencias">
        <ProgressTemplate>
            <table style="width: 100%; height: 100%;">
                <tr>
                    <td style="align-content: center; align-items: center; align-self: center; text-align: center;">
                        <h1>Obteniendo información, espere por favor...</h1>
    ...
    <asp:UpdatePanel ID="upListaLicencias" runat="server">
        <ContentTemplate>
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
                        <asp:GridView ID="gvLicencias" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <%--<asp:BoundField DataField="SEXO" HeaderText="SEXO" ReadOnly="True" SortExpression="SEXO"></asp:BoundField>--%>
            ...
            <asp:EntityDataSource runat="server" ID="edsLicencias" DefaultContainerName="SILCVEREntities"
                ...
                EntityTypeFilter="vLicencias_UNION" Where="(@NOMBRE IS NULL || it.NOMBRE LIKE '%' + @NOMBRE + '%') && 
                (@PRIMER IS NULL ||it.APELLIDO_PATERNO LIKE '%' + @PRIMER + '%') && 
                (@SEGUNDO IS NULL ||it.APELLIDO_MATERNO LIKE '%' + @SEGUNDO + '%') " OrderBy="it.RFC, it.CURP, it.FECHA_REGISTRO DESC" >
                <WhereParameters>
                    ...
                    <%--<asp:ControlParameter ControlID="txtCP" DefaultValue="" ConvertEmptyStringToNull="true" Name="CP" Type="String" />
                    <asp:ControlParameter ControlID="txtCalle" DefaultValue="" ConvertEmptyStringToNull="true" Name="CALLE" Type="String" />
                    <asp:ControlParameter ControlID="txtColonia" DefaultValue="" ConvertEmptyStringToNull="true" Name="COLONIA" Type="String" />
                    <asp:ControlParameter ControlID="txtMunicipio" DefaultValue="" ConvertEmptyStringToNull="true" Name="MUNICIPIO" Type="String" />--%>
                </WhereParameters>
        ...
        <ContentTemplate>
            <div class="row" id="DIV_DETALLES" runat="server">
                <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
                    ...
                    <%--<div class="input-group">
                        <span class="input-group-addon" style="min-width: 150px; text-align: left;">
                            <i class="glyphicon glyphicon-user"></i>Fecha Registro
                        </span>
                        <asp:TextBox ID="txtDetFechaReg" runat="server" Width="100%" autocomplete="off" Enabled="false"></asp:TextBox>
                    </div>--%>
                    <div class="input-group">
                        <span class="input-group-addon" style="min-width: 150px; text-align: left;">
